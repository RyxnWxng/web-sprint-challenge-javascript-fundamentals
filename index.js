...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// Because the internal function is in the local scope within the function
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(zooAnimals){
    const lowerNames = zooAnimals.map(element => element.animal_name.toLowerCase());
    return lowerNames
  }
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals){
    const lowerPopAnimals = zooAnimals.filter(element => element.population < 5);
  ...
  */
  ...
  function USApop(zooAnimals){
    const totalPop = zooAnimals.reduce((accumulator, currentValue) => accumulator + currentValue.population, 0);
    return totalPop
  }
  USApop(zooAnimals)
